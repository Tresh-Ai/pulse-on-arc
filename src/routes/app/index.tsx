...
export const Route = createFileRoute("/app/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Your Pulse timeline: market takes, charts, polls and live prediction markets.",
      },
...
function HomeFeed() {
  ...
  return (
    <div>
      <ColumnHeader tabs={<TabStrip value={filter} onChange={setFilter} options={TABS} />} />
      <InlineComposer />
